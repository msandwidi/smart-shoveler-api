...
const login_fetch_account = async (req, res, next) => {
	try {
		...
		console.log("auth user detail sent =>", user);
...
module.exports = (app) => {
	...
	app.put(`/api/v1/users/account/profile`, authenticate, put_update_profile);
	app.put(`/api/v1/users/account/password`, authenticate, put_change_password);
